...
public enum PaxelToolMaterial implements ToolMaterial {
    ...
    PaxelToolMaterial(int miningLevel, double itemDurability, float miningSpeed, float attackDamage, int enchantability, Supplier<Ingredient> repairIngredient) {
